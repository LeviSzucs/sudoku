-- Solo leaderboards include completed Classic/Daily results even when hints,
-- mistakes, or undos were used. Those actions are already score penalties.

update public.game_results
set eligible_for_leaderboard = true
where mode in ('classic', 'daily')
  and completed = true;
