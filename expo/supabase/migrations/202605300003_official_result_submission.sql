-- Backend-owned official puzzle result finalisation.
-- The client submits only observable completion data; this function validates
-- the owned session and puzzle solution, then calculates score, XP, stats, and
-- achievement progress server-side.
