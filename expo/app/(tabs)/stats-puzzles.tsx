...
export default function PuzzleStatsScreen() {
  ...
  const total = filter === "All time" ? Math.max(profile.puzzles_completed, results.length) : results.length;
