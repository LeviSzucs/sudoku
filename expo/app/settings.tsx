...
export default function SettingsScreen() {
  ...
  const { profile, diagnostics, updateDisplayName, updateNotificationSettings, updatePrivacySettings, simulateResult, simulateRankedWin, simulateRankedLoss, resetLocalProfile, testSupabaseRead, testSupabaseWrite, repairMissingProfileRows, repairCompletedSessions } = profileState;
...
function Diagnostic({ label, value }: { label: string; value: string }) { return <View style={styles.diagnostic}><Text style={styles.diagnosticLabel}>{label}</Text><Text style={styles.diagnosticValue} numberOfLines={2}>{value}</Text></View>; }
